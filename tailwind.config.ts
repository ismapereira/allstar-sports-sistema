	...
	theme: {
		...
		extend: {
			colors: {
				...
				primary: {
					DEFAULT: '#00AFEF', // cor-primaria
					light: '#33C1F3',   // cor-primaria-claro
					dark: '#0097D6',    // cor-primaria-escuro
					foreground: 'hsl(var(--primary-foreground))'
				},
				secondary: {
					DEFAULT: '#001E5A', // cor-secundaria
					light: '#1A3A7C',   // cor-secundaria-claro
					dark: '#001133',    // cor-secundaria-escuro
